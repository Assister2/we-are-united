...
function Navbar() {
  ...
  return (
    <chakra.header bg={bg} w="100%" fontFamily="Montserrat">
      <Container maxW="container.md" py={5} align="center">
        <Flex justify={"space-between"} >
          <Center>
            <Image height="3rem" src="../../assets/site_logo.png" alt='site logo' />
          </Center>
          <Center marginLeft={100}>
            <HStack spacing='24px' verticalAlign="middle">
          ...
          <Flex gap={5}>
            <Center>
              <Button backgroundColor="orange" alignItems="center">
                допомогти
              </Button>
            </Center> 
