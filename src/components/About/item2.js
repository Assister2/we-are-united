...
function AboutItem2() {
   ...
   const about = []; 
   const about1 = 
    `З початку російського вторгнення в Україну, наша команда МБФ “Ми Єдині” спільно з волонтерами та небайдужими громадянами допомагають нашим військовим на фронті. `;
   ...
   return (
    ...
    <Box py={"70px"} textAlign={"left"} fontSize={font32}>
        допомога армії та військовим україни
    </Box>
    <Box>
        <VStack spacing={10}>
            <Box>
